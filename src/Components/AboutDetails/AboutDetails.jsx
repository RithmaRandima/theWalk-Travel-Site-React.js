  ...
  return (
    ...
    >
      <div className="h-[90vh] flex items-center justify-center relative">
        ...
        <div className="absolute h-[140px] w-[140px] bg-transparent border-2 border-[#00ffee] border-dashed rounded-full overflow-hidden p-2 top-[100px] left-[-10px]">
          <img
            src={img3}
            className="w-[100%] h-[100%] object-cover rounded-full"
            alt=""
        ...
        <div className="absolute h-[180px] w-[180px] bg-transparent border border-[#00ffee] border-dashed rounded-full overflow-hidden p-2 right-[30px] bottom-[-30px]">
          <img
            src={img3}
            className="w-[100%] h-[100%] object-cover rounded-full"
            alt=""
...
{
  /*
   <div className="flex flex-row gap-2 h-[90vh] bg-black ">
