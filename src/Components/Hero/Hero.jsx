...
function Hero() {
  return (
    <div className="w-full h-[100vh] relative">
      <Parallax strength={200} className="w-[100%] h-[100vh] relative">
        ...
        <div className="max-w-[1140px] m-auto ">
          <div className="absolute top-[40%] md:top-[100px] left-[50%] translate-x-[-50%] md:translate-y-[5px] translate-y-[40%] w-full  max-w-[700px] h-fit flex flex-col text-white  p-4 text-center">
            <motion.h1
              ...
              className="font-extrabold text-[53px] md:text-[80px] uppercase"
            >
        ...
        <motion.div
          ...
          className="block absolute z-10 w-[100%] md:h-[92vh] h-[95vh]"
        >
          <Booking />
        </motion.div>
      </Parallax>
