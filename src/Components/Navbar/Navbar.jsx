...
const Navbar = () => {
  ...
  return (
    <div className="w-full min-h-[50px] flex justify-between items-center absolute z-10 text-white px-4">
      ...
      <div className="flex items-center">
        <h1 className="text-xl text-[#fff] ">
          <span className="font-bold text-[#ff00008d] text-[24px]">WAL</span>
        </h1>
      </div>
      ...
      <div className="flex justify-between">
        ...
        <button className="uppercase text-[10px] bg-[#00ffee] px-4 rounded-[50px]">
          Contact Us
        </button>
      </div>
      {/* Hamburger Icon */}
